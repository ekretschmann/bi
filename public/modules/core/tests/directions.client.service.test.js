...
(function () {
    describe('DirectionsService', function () {
        ...
        it('should find a alternative routs without changes', function () {
            ...
            //expect(journey1.destination.stop).toBe('Stop 2');
        ...
        //
        //    expect(journeyPlan.departure.stop).toBe('Stop 1');
        //    expect(journeyPlan.destination.stop).toBe('Stop 2');
        ...
        //
        //
        //    expect(journeyPlan.departure.stop).toBe('Stop 2');
        //    expect(journeyPlan.destination.stop).toBe('Stop 4');
